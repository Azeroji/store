    ...
    <div className='flex justify-center'>
      ...
      <div className='mt-[2vw] lg:drop-shadow-2xl xl:h-[75vh] w-[100%] lg:w-[60vw] bg-[white] rounded-[18px] flex content-clip p-[10px]'>
        ...
        <div className='px-[5%] w-[100%] xl:w-[70%] flex items-center justify-center'>
          ...
          <p className='font-bold text-[32px] mb-[5%] text-center'>Sign up</p>
            <form>
              <div className='flex justify-between'>
                <div>
                  <p>First Name</p>
                  <input onChange={handleChange} placeholder="First Name" className="bg-[#ededed] rounded-[4px] h-[40px] text-[14px] my-[10px] w-[90%] md:w-[100%] focus:outline-none px-[15px]" name="email" type="email" />
                </div>
                <div>
                  <p>Last Name</p>
                  <input onChange={handleChange} placeholder="Last Name" className="bg-[#ededed] rounded-[4px] h-[40px] text-[14px] my-[10px] w-[90%] md:w-[100%] focus:outline-none px-[15px]" name="email" type="email" />
                </div>
              </div>
              <p>Username</p>
